import { RefreshCw, Database, HardDrive, Calendar } from 'lucide-react'
import appConfig from '../../data/config.json'

export default function Header({ source, lastUpdated, year, loading, onRefetch }) {
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-display font-bold text-slate-900 text-sm sm:text-base leading-tight truncate">
                {appConfig.entidad}
              </h1>
